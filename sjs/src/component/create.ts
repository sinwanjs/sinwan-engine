...
import type { SjsComponent, SjsPage, SjsNode, SjsSlots } from "../types.ts";
...
export function createLayout<P extends object = {}>(
  fn: (
    props: P & { children: SjsNode },
  ) => ReturnType<SjsComponent<P & { children: SjsNode }>>,
