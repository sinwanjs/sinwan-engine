...
import { signal, nextTick } from "../../reactivity/index.ts";
import { mount } from "../../renderer/mount.ts";
import { createComponent } from "../../../view/component.ts";
import { onMounted, onUnmounted, onUpdated, onError } from "../lifecycle.ts";
import { provide, inject } from "../provide-inject.ts";
...
describe("provide/inject", () => {
  ...
  it("throws when called outside setup", () => {
    expect(() => provide(Symbol(), "val")).toThrow("outside of component setup");
